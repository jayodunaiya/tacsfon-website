...
const UpcomingEventsHome = () => {
   ...
   * Much weaker than the photograph.
   */
          ...
          {upcomingEvents.map((event, index) => (
            <StaggerItem key={event.id}>
              ...
              >
                <Link
                  href={event.href}
                  className="group relative grid gap-7 border-b border-black/10 py-8 transition-all duration-300 md:grid-cols-[140px_1fr_auto] md:items-center lg:grid-cols-[160px_1fr_260px_60px] lg:py-10"
                >
                  {/* Hover Background */}
                  ...
                  <div className="hidden justify-end lg:flex">
                    <span className="flex h-12 w-12 items-center justify-center rounded-full border border-black/15 transition-all duration-300 group-hover:-rotate-45 group-hover:border-green-700 group-hover:bg-green-700 group-hover:text-white">
                      <FiArrowRight />
                    </span>
                  </div>
        ...
        >
          ...
          >
            <div>
              ...
              >
                Stay informed about upcoming services, gatherings,
                programmes and special events happening within the church.
              </motion.p>
            </div>
